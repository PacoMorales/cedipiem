...
@section('content')
	<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="card">
						<div class="card-header text-md-center" style="color: gray;"><i class="fa fa-user"></i> {{ 'MANTENIMIENTO DEL DIRECTORIO DE PADRINOS' }}<div class="text-md-center" style="color:blue; ">{{'DEPENDENCIA, ORGANISMO O AYUNTAMIENTO: '}}  {!! $clasificgob->clasificgob_desc !!}</div></div>
							<!--<div class="card-body">-->
							...
							<table class="table table-striped table-bordered table-sm">
							  ...
							  <tbody class="text-md-center">
							  	@foreach($totales as $padrino)
									...
									<!--<th>{{ $clasificgob->clasificgob_desc }}</th>-->
									...
									<a href="#" class="btn btn-secondary" title="Borrar"><i class="fa fa-trash"></i></th>
									</tr>
								@endforeach
							  </tbody>
							</table> 
							{!! $totales->appends(request()->input())->links() !!}
							</div>
						</div>
					</div>
				</div>
